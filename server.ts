...
if (privateKey) {
  try {
    ...
    // Vercel sering melakukan hot-reload, kita pastikan tidak inisialisasi ulang
...
if (process.env.NODE_ENV !== "production" && !process.env.VERCEL) {
  ...
  // Logic untuk production lokal (misal: node server.ts) bukan di Vercel
...
// WAJIB UNTUK VERCEL: Mengekspor aplikasi express agar Vercel Serverless Function bisa membacanya
export default app;
